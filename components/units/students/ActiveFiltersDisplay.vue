<template>
    <div v-if="hasActiveFilters" class="mb-4 flex flex-wrap items-center gap-2">
        ...
        <div v-if="filters.diamonds"
            ...
            <button class="text-blue-600 hover:text-blue-800 transition-colors" title="Remove filter"
        ...
        <div v-if="filters.progress"
            ...
            <button class="text-green-600 hover:text-green-800 transition-colors" title="Remove filter"
